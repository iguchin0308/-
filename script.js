...
const CARDS = [
  ...
  { title: "ラッキーセブン", category: "即決", rule: "全員でせーので1〜10の数字を言う。『7』を言った人が飲む（複数なら全員）。" },
  { title: "ハイタッチ", category: "即決", rule: "せーので全員ハイタッチ。最後に手が合った（触れた）のが遅い人が飲む。" },
  { title: "ツッコミ王", category: "即決", rule: "引いた人がボケを1つ。最初にツッコめた人はセーフ、遅れた人が1口（判定は場の空気）。" },
  { title: "笑ったら負け", category: "心理戦", rule: "10秒間無言で我慢。最初に笑った人が飲む。" },
  { title: "ジェスチャー", category: "チャレンジ", rule: "引いた人が動物をジェスチャー。最初に当てた人はセーフ、当てられないまま10秒で全員1口。" }
];

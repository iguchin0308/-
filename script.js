...
const CARDS = [
  ...
  { title: "サントリー", category: "回数", rule: "この飲み会中に、3回目にこのカードが引かれた時、引いた人は1杯飲み干す。1・2回目は、飲まなくてOK。" },
  ...
  { title: "最年長or最年少", category: "プロフィール", rule: "残り枚数が奇数なら最年長。偶数なら最年少が飲む。" },
  { title: "地雷", category: "心理戦", rule: "引いた人が、NGワードを決める。次にそれを言った人は2杯飲む。" },
  { title: "10秒チャレンジ", category: "即決", rule: "みんなで、ストップウォッチをスタート。10秒から一番遠かった人が1杯飲む。" },
  { title: "メデゥーサ", category: "心理戦", rule: "引いた人と最初に目が合った人が1口飲む。10秒誰とも目が合わなければ引いた人が飲む。" },
  { title: "遅刻", category: "当日ネタ", rule: "今日の飲み会に一番遅刻した人が1口飲む。" },
  { title: "人気者", category: "即決", rule: "全員スマホを出す。一番最近LINE/DMの通知が来た人が1口飲む。" },
  { title: "キス", category: "当日ネタ", rule: "一番最近キスした人が1口飲む（言いたくない人は1口で回避OK）。" },
  { title: "ラッパー", category: "チャレンジ", rule: "引いた人が早口言葉を決める。順番に言い、噛んだ人が1口飲む。" },
  { title: "〇〇を探せ！", category: "即決", rule: "引いた人がお題を決める。一番探すのが遅かった人が、1口飲む。（赤色のモノを探せ。）" },
  ...
  { title: "お手洗い", category: "即決", rule: "一番最近トイレ行った人が1口が飲む。" },
  ...
  { title: "二択ジャッジ", category: "即決", rule: "引いた人が二択を出す。引いた人が回答を考え、他の人は予想。外れた人は1口飲む。（このメンバーで旅行行くなら北海道or沖縄？）" },
  { title: "多数決", category: "即決", rule: "引いた人が質問を1つ。少数派が1口飲む。（きのこ派orたけのこ派）" },
  { title: "ワンワード", category: "即決", rule: "引いた人がお題を1つ。全員漢字1語で答える。被った人が1口飲む。（例：夏といえば？→ 海／祭／蝉）" },
  { title: "メガシャキ", category: "即決", rule: "引いた人がスタートと言う。その後一番早くまばたきした人が2口飲む。" },
